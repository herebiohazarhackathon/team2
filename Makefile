...
# Template: lib
# Command: /home/anna/Qt/5.10.1/gcc_64/bin/qmake -o Makefile ../team2_sample/team2.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
QMAKE         = /home/anna/Qt/5.10.1/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/anna/Qt/5.10.1/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/anna/Qt/5.10.1/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
...
COMPRESS      = gzip -9f
DISTNAME      = team21.0.0
DISTDIR = /home/anna/QTProjects/team2/team2/.tmp/team21.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/anna/Qt/5.10.1/gcc_64/lib -shared -Wl,-soname,libteam2.so.1
LIBS          = $(SUBLIBS) -L/home/anna/Qt/5.10.1/gcc_64/lib -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
