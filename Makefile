...
# Project:  ../sources/team2.pro
# Template: lib
# Command: /home/vlad/Qt5.7.0/5.7/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ../sources/team2.pro
#############################################################################
...
INCPATH       = -I../sources -I. -I../../../Qt5.7.0/5.7/gcc_64/include -I../../../Qt5.7.0/5.7/gcc_64/include/QtCore -I. -I../../../Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++
QMAKE         = /home/vlad/Qt5.7.0/5.7/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
COMPRESS      = gzip -9f
DISTNAME      = team21.0.0
DISTDIR = /home/vlad/Development/hackathon/build/.tmp/team21.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/vlad/Qt5.7.0/5.7/gcc_64/lib -shared -Wl,-soname,libteam2.so.1
LIBS          = $(SUBLIBS) -L/home/vlad/Qt5.7.0/5.7/gcc_64/lib -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = ../../../Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf \
		...
		../sources/team2.pro ../sources/team2.h \
		../sources/team2_global.h \
		../sources/unique_chars.h \
		../sources/huffman.h \
		../sources/derivative.h \
		../sources/sort_array.h \
		../sources/gcd_string.h ../sources/team2.cpp
QMAKE_TARGET  = team2
DESTDIR       = 
...
Makefile: ../sources/team2.pro ../../../Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++/qmake.conf ../../../Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf \
		../../../Qt5.7.0/5.7/gcc_64/mkspecs/common/unix.conf \
		../../../Qt5.7.0/5.7/gcc_64/mkspecs/common/linux.conf \
		../../../Qt5.7.0/5.7/gcc_64/mkspecs/common/sanitize.conf \
		../../../Qt5.7.0/5.7/gcc_64/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ../sources/team2.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents ../sources/team2.h ../sources/team2_global.h ../sources/unique_chars.h ../sources/huffman.h ../sources/derivative.h ../sources/sort_array.h ../sources/gcd_string.h $(DISTDIR)/
	$(COPY_FILE) --parents ../sources/team2.cpp $(DISTDIR)/
...
team2.o: ../sources/team2.cpp ../sources/team2.h \
		../sources/team2_global.h \
		...
		../sources/sort_array.h \
		../sources/unique_chars.h \
		../sources/gcd_string.h \
		../sources/huffman.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o team2.o ../sources/team2.cpp
